...
class AsherPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        ...
        project.dependencies {
            debugCompile 'com.xtc.ouyangfan.aop:aop-time-runtime:0.0.8-SNAPSHOT'
            debugCompile 'org.aspectj:aspectjrt:1.8.6'
            compile  'com.xtc.ouyangfan.aop:aop-time-annotations:0.0.8-SNAPSHOT'
        }
